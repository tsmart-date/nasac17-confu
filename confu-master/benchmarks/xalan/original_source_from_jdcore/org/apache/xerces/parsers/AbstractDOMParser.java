  ...
  extends AbstractXMLDocumentParser
{
    ...
    throws XNIException
  {
    ...
    if (!fDeferNodeExpansion)
    {
      ...
      for (k = 0; k < i; k++)
      {
        paramXMLAttributes.getName(k, fAttrQName);
        localObject2 = createAttrNode(fAttrQName);
        localObject3 = paramXMLAttributes.getValue(k);
        ...
        if (fDocumentImpl != null)
        {
          ...
          {
            localObject4 = localAttributePSVI.getMemberTypeDefinition();
            if (localObject4 == null)
            {
              localObject4 = localAttributePSVI.getTypeDefinition();
              if (localObject4 != null)
              {
                bool3 = ((XSSimpleType)localObject4).isIDType();
          ...
          {
            boolean bool4 = Boolean.TRUE.equals(paramXMLAttributes.getAugmentations(k).getItem("ATTRIBUTE_DECLARED"));
            if (bool4)
            {
              localObject4 = paramXMLAttributes.getType(k);
              bool3 = "ID".equals(localObject4);
            }
            localAttrImpl.setType(localObject4);
          }
          if (bool3) {
          ...
          localAttrImpl.setSpecified(paramXMLAttributes.isSpecified(k));
        }
      }
      setCharacterData(false);
      ...
      if ((fDOMFilter != null) && (!fInEntityRef)) {
        ...
        {
          fRoot.setValues(paramQName);
        }
        else
        {
          m = fDOMFilter.startElement((Element)localObject1);
          switch (m)
          {
          case 4: 
            throw abort;
          case 2: 
            fFilterReject = true;
            fRejectedElement.setValues(paramQName);
            return;
          case 3: 
            fSkippedElemStack.push(paramQName.clone());
            return;
          }
        }
      }
      fCurrentNode.appendChild((Node)localObject1);
    ...
    else
    {
      ...
      int j = fDeferredDocumentImpl.createDeferredElement(fNamespaceAware ? uri : null, rawname, localObject1);
      k = paramXMLAttributes.getLength();
      for (m = 0; m < k; m++)
      {
        localObject3 = (AttributePSVI)paramXMLAttributes.getAugmentations(m).getItem("ATTRIBUTE_PSVI");
        boolean bool1 = false;
        if ((localObject3 != null) && (fNamespaceAware))
        {
          localObject1 = ((ItemPSVI)localObject3).getMemberTypeDefinition();
          if (localObject1 == null)
          {
            localObject1 = ((ItemPSVI)localObject3).getTypeDefinition();
            if (localObject1 != null) {
        ...
        fDeferredDocumentImpl.setDeferredAttribute(j, paramXMLAttributes.getQName(m), paramXMLAttributes.getURI(m), paramXMLAttributes.getValue(m), paramXMLAttributes.isSpecified(m), bool1, localObject1);
      }
    ...
    throws XNIException
  {
    if (!fDeferNodeExpansion)
    {
      ...
      if (fDOMFilter != null)
      {
        if (fFilterReject)
        {
          if (paramQName.equals(fRejectedElement)) {
            fFilterReject = false;
          }
          return;
        }
        if ((!fSkippedElemStack.isEmpty()) && (fSkippedElemStack.peek().equals(paramQName)))
        {
          fSkippedElemStack.pop();
          return;
        }
        setCharacterData(false);
        if ((!fRoot.equals(paramQName)) && (!fInEntityRef) && ((fDOMFilter.getWhatToShow() & 0x1) != 0))
        {
    ...
    throws XNIException
  {
    ...
    if (fDeferredDocumentImpl != null)
    {
      if (paramXMLString1 != null)
      {
        ...
        int j = fDeferredDocumentImpl.createDeferredAttribute(paramString2, paramXMLString1.toString(), false);
    ...
    else if ((fDocumentImpl != null) && (paramXMLString1 != null))
    {
      ...
      if (bool)
      {
        ...
        localAttrImpl = (AttrImpl)fDocumentImpl.createAttributeNS(str, paramString2);
      }
      else
      {
