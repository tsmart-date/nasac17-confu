  ...
  implements XMLDTDHandler, XMLDTDContentModelHandler, EntityState, Grammar
{
    ...
    throws XNIException
  {
    ...
    fElementDeclIsExternal[i][j] = (fReadingExternalDTD ? 1 : 0);
  }
    ...
    throws XNIException
  {
    ...
    fAttributeDeclIsExternal[j][k] = (fReadingExternalDTD ? 1 : 0);
  }
    ...
    throws XNIException
  {
    ...
    if (i == -1)
    {
      ...
      boolean bool2 = fReadingExternalDTD;
    ...
    throws XNIException
  {
    ...
    if (fGrammarDescription.getRootName() == null)
    {
      ...
      for (int k = 0; k < fElementDeclCount; k++)
      {
        int i = k >> 8;
        j = k & 0xFF;
      ...
      fGrammarDescription.setPossibleRoots(localVector);
    }
  }
