  ...
  implements XMLComponent, XMLDTDFilter, XMLDTDContentModelFilter
{
    ...
    throws XNIException
  {
    if (fValidation) {
      if (fDTDElementDecls.contains(paramString1)) {
        ...
        fDTDElementDecls.addElement(paramString1);
      }
    }
    if (fDTDGrammar != null) {
    ...
    throws XNIException
  {
    ...
    {
      DTDGrammar localDTDGrammar = fDTDGrammar != null ? fDTDGrammar : fGrammarBucket.getActiveGrammar();
      Enumeration localEnumeration = fNDataDeclNotations.keys();
      while (localEnumeration.hasMoreElements())
      {
        localObject1 = (String)localEnumeration.nextElement();
        localObject2 = (String)fNDataDeclNotations.get(localObject1);
        if (localDTDGrammar.getNotationDeclIndex((String)localObject2) == -1) {
          fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "MSG_NOTATION_NOT_DECLARED_FOR_UNPARSED_ENTITYDECL", new Object[] { localObject1, localObject2 }, (short)1);
        }
      }
      Object localObject1 = fNotationEnumVals.keys();
      String str1;
      while (((Enumeration)localObject1).hasMoreElements())
      {
        localObject2 = (String)((Enumeration)localObject1).nextElement();
        str1 = (String)fNotationEnumVals.get(localObject2);
        if (localDTDGrammar.getNotationDeclIndex((String)localObject2) == -1) {
          fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "MSG_NOTATION_NOT_DECLARED_FOR_NOTATIONTYPE_ATTRIBUTE", new Object[] { str1, localObject2 }, (short)1);
        }
      }
      Object localObject2 = fTableOfNOTATIONAttributeNames.keys();
      while (((Enumeration)localObject2).hasMoreElements())
      {
        ...
        {
          String str2 = (String)fTableOfNOTATIONAttributeNames.get(str1);
    ...
    throws XNIException
  {
    if ((fMixed) && (fValidation)) {
      if (fMixedElementTypes.contains(paramString)) {
        ...
        fMixedElementTypes.addElement(paramString);
      }
    }
    if (fDTDGrammar != null) {
