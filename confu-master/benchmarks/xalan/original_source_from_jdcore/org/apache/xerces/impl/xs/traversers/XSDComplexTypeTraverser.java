  ...
  extends XSDAbstractParticleTraverser
{
    ...
    throws XSDComplexTypeTraverser.ComplexTypeRecoverableError
  {
    ...
    else
    {
      ...
      if (fDerivedBy == 2)
      {
        fAttrChecker.returnAttrArray(arrayOfObject1, paramXSDocumentInfo);
        fAttrChecker.returnAttrArray((Object[])localObject1, paramXSDocumentInfo);
        throw new ComplexTypeRecoverableError("src-ct.2.1", new Object[] { fName, ((XSObject)localObject2).getName() }, localElement1);
      }
    ...
    if (fDerivedBy == 2)
    {
      if ((localElement1 != null) && (DOMUtil.getLocalName(localElement1).equals(SchemaSymbols.ELT_SIMPLETYPE)))
      {
        ...
        if ((localObject2 != null) && (!XSConstraints.checkSimpleDerivationOk((XSSimpleType)localObject4, (XSTypeDefinition)localObject2, ((XSTypeDefinition)localObject2).getFinal())))
        {
          fAttrChecker.returnAttrArray(arrayOfObject1, paramXSDocumentInfo);
          fAttrChecker.returnAttrArray((Object[])localObject1, paramXSDocumentInfo);
          throw new ComplexTypeRecoverableError("derivation-ok-restriction.5.2.2.1", new Object[] { fName, ((XSObject)localObject4).getName(), ((XSObject)localObject2).getName() }, localElement1);
        }
      ...
      fXSSimpleType = schemaFactory.createTypeRestriction(null, fTargetNamespace, (short)0, (XSSimpleType)localObject2, null);
      try
      {
    ...
    throws XSDComplexTypeTraverser.ComplexTypeRecoverableError
  {
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      {
        throw new ComplexTypeRecoverableError("ct-props-correct.4", new Object[] { paramString, fAttrDecl.getName() }, paramElement);
      }
    }
    if (paramBoolean) {
    ...
    throws XSDComplexTypeTraverser.ComplexTypeRecoverableError
  {
    ...
    if ((localXSParticleDecl == null) && (paramBoolean1))
    {
      if (fEmptyParticle == null)
      {
        ...
        fEmptyParticle.fValue = ((XSTerm)localObject);
      }
      localXSParticleDecl = fEmptyParticle;
    }
