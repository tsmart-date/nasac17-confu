  ...
  extends AbstractDateTimeDV
{
  ...
  {
    return factory.newXMLGregorianCalendar(BigInteger.valueOf(unNormYear), unNormMonth, unNormDay, unNormHour, unNormMinute, (int)unNormSecond, unNormSecond != 0.0D ? new BigDecimal(unNormSecond - (int)unNormSecond) : null, timezoneHr * 60 + timezoneMin);
  }
}
