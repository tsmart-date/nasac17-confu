...
public class XSAttributeChecker
{
      ...
      else
      {
        ...
        while (localStringTokenizer1.hasMoreTokens())
        {
          ...
          if (str2.equals("substitution")) {
            ...
            throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3", new Object[] { str1, "(#all | List of (substitution | extension | restriction | list | union))" });
          }
        }
      }
  ...
  {
    Enumeration localEnumeration = fNonSchemaAttrs.keys();
    while (localEnumeration.hasMoreElements())
    {
      ...
      if (localSchemaGrammar != null)
      {
        ...
        if (localXSAttributeDecl != null)
        {
          ...
          {
            Vector localVector = (Vector)fNonSchemaAttrs.get(str1);
