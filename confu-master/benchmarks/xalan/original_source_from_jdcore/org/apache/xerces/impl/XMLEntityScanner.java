  ...
  implements XMLLocator
{
  ...
  public void setCurrentEntity(XMLEntityManager.ScannedEntity paramScannedEntity)
  {
  ...
  public void reset(SymbolTable paramSymbolTable, XMLEntityManager paramXMLEntityManager, XMLErrorReporter paramXMLErrorReporter)
  {
    fCurrentEntity = null;
  ...
  {
    fCurrentEntity.baseCharOffset += fCurrentEntity.position - fCurrentEntity.startPosition;
    int i = fCurrentEntity.mayReadChunks ? fCurrentEntity.ch.length - paramInt : 64;
