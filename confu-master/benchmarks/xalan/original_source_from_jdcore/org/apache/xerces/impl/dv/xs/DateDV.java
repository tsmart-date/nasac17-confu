  ...
  extends DateTimeDV
{
  ...
  {
    return factory.newXMLGregorianCalendar(unNormYear, unNormMonth, unNormDay, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, timezoneHr * 60 + timezoneMin);
  }
}
