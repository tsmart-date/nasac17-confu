  ...
  implements XMLComponent, XMLEntityResolver
{
  ...
  private CharacterBufferPool fBufferPool = new CharacterBufferPool(fBufferSize, 512);
    ...
    throws IOException, XNIException
  {
    ...
    fCurrentEntity = new ScannedEntity(paramString, new XMLResourceIdentifierImpl(str1, (String)localObject1, (String)localObject2, (String)localObject4), (InputStream)localObject3, localReader, str2, paramBoolean1, false, paramBoolean2);
  ...
  public void reset()
  {
    ...
    {
      Enumeration localEnumeration = fDeclaredEntities.keys();
      while (localEnumeration.hasMoreElements())
      {
        Object localObject1 = localEnumeration.nextElement();
        Object localObject2 = fDeclaredEntities.get(localObject1);
  ...
  private static class CharacterBufferPool
  {
    ...
    {
      if (XMLEntityManager.CharacterBuffer.access$300(paramCharacterBuffer))
      {
    ...
    extends XMLEntityManager.Entity
  {
    ...
    private XMLEntityManager.CharacterBuffer fBuffer;
    
    public ScannedEntity(String paramString1, XMLResourceIdentifier paramXMLResourceIdentifier, InputStream paramInputStream, Reader paramReader, String paramString2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
    {
      ...
      fBuffer = fBufferPool.getBuffer(paramBoolean3);
      ch = fBuffer.ch;
    }
