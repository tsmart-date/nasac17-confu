  ...
  extends DurationDV
{
  ...
  protected Duration getDuration(AbstractDateTimeDV.DateTimeData paramDateTimeData)
  {
    ...
    return factory.newDuration(i == 1, year != Integer.MIN_VALUE ? BigInteger.valueOf(i * year) : null, month != Integer.MIN_VALUE ? BigInteger.valueOf(i * month) : null, null, null, null, null);
  }
}
