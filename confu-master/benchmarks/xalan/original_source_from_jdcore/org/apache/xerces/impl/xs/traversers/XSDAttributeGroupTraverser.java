  ...
  extends XSDAbstractTraverser
{
  ...
  XSAttributeGroupDecl traverseGlobal(Element paramElement, XSDocumentInfo paramXSDocumentInfo, SchemaGrammar paramSchemaGrammar)
  {
    ...
    Object localObject2 = (XSAttributeGroupDecl)fSchemaHandler.getGrpOrAttrGrpRedefinedByRestriction(2, new QName(XMLSymbols.EMPTY_STRING, str, str, fTargetNamespace), paramXSDocumentInfo, paramElement);
    Object localObject3;
