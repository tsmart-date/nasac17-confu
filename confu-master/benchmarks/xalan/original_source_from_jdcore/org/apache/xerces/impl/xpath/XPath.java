    ...
    throws XPathException
  {
    ...
    Scanner local1 = new Scanner(fSymbolTable)
    {
      protected void addToken(XPath.Tokens paramAnonymousTokens, int paramAnonymousInt)
        throws XPathException
      {
        if ((paramAnonymousInt == 6) || (paramAnonymousInt == 11) || (paramAnonymousInt == 21) || (paramAnonymousInt == 4) || (paramAnonymousInt == 9) || (paramAnonymousInt == 10) || (paramAnonymousInt == 22) || (paramAnonymousInt == 23))
        {
