  ...
  extends AbstractDateTimeDV
{
  ...
  {
    return factory.newXMLGregorianCalendar(null, Integer.MIN_VALUE, Integer.MIN_VALUE, unNormHour, unNormMinute, (int)unNormSecond, unNormSecond != 0.0D ? new BigDecimal(unNormSecond - (int)unNormSecond) : null, timezoneHr * 60 + timezoneMin);
  }
}
