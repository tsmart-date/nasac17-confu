  ...
  implements XMLComponent, XMLDocumentFilter, FieldActivator, RevalidationHandler
{
    ...
    throws XMLConfigurationException
  {
    ...
    try
    {
      fRootTypeQName = ((javax.xml.namespace.QName)paramXMLComponentManager.getProperty("http://apache.org/xml/properties/validation/schema/root-type-definition"));
    }
  ...
  Augmentations handleStartElement(org.apache.xerces.xni.QName paramQName, XMLAttributes paramXMLAttributes, Augmentations paramAugmentations)
  {
    ...
    {
      localObject3 = fRootTypeQName.getNamespaceURI();
      if ((localObject3 != null) && (((String)localObject3).equals(""))) {
        localObject3 = null;
      }
      localObject4 = findSchemaGrammar((short)5, (String)localObject3, null, null, null);
      if (localObject4 != null) {
        fCurrentType = ((SchemaGrammar)localObject4).getGlobalTypeDecl(fRootTypeQName.getLocalPart());
      }
      if (fCurrentType == null)
      {
        String str3 = fRootTypeQName.getPrefix() + ":" + fRootTypeQName.getLocalPart();
        reportSchemaError("cvc-type.1", new Object[] { str3 });
      }
    }
    if (fCurrentType == null)
    {
  ...
  Augmentations handleEndElement(org.apache.xerces.xni.QName paramQName, Augmentations paramAugmentations)
  {
    ...
    if (fIDCChecking)
    {
      ...
      for (int j = i - 1; j >= 0; j--)
      {
        ...
        if (fCurrentElemDecl == null) {
          localXPathMatcher1.endElement(paramQName, null, false, fValidatedInfo.actualValue, fValidatedInfo.actualValueType, fValidatedInfo.itemValueTypes);
        } else {
  ...
  SchemaGrammar findSchemaGrammar(short paramShort, String paramString, org.apache.xerces.xni.QName paramQName1, org.apache.xerces.xni.QName paramQName2, XMLAttributes paramXMLAttributes)
  {
    ...
    if (localSchemaGrammar == null)
    {
      ...
      Object localObject = fLocationPairs.get(paramString == null ? XMLSymbols.EMPTY_STRING : paramString);
      if (localObject != null) {
        arrayOfString1 = ((XMLSchemaLoader.LocationArray)localObject).getLocationArray();
      }
      if ((arrayOfString1 != null) && (arrayOfString1.length != 0))
      {
        fXSDDescription.fLocationHints = new String[arrayOfString1.length];
        System.arraycopy(arrayOfString1, 0, fXSDDescription.fLocationHints, 0, arrayOfString1.length);
      }
      if (fGrammarPool != null)
      {
      ...
      if ((localSchemaGrammar == null) && (!fUseGrammarPoolOnly)) {
        try
        {
          XMLInputSource localXMLInputSource = XMLSchemaLoader.resolveDocument(fXSDDescription, fLocationPairs, fEntityResolver);
  ...
  void processOneAttribute(org.apache.xerces.xni.QName paramQName, XMLAttributes paramXMLAttributes, int paramInt, XSAttributeDecl paramXSAttributeDecl, XSAttributeUseImpl paramXSAttributeUseImpl, AttributePSVImpl paramAttributePSVImpl)
  {
    ...
    if ((localObject1 != null) && (paramXSAttributeDecl.getConstraintType() == 2) && ((!ValidatedInfo.isComparable(fValidatedInfo, fDefault)) || (!localObject1.equals(fDefault.actualValue)))) {
      reportSchemaError("cvc-attribute.4", new Object[] { rawname, fTempQName.rawname, str, fDefault.stringValue() });
    }
    if ((localObject1 != null) && (paramXSAttributeUseImpl != null) && (fConstraintType == 2) && ((!ValidatedInfo.isComparable(fValidatedInfo, fDefault)) || (!localObject1.equals(fDefault.actualValue)))) {
  ...
  protected class ValueStoreCache
  {
    ...
    public void endElement()
    {
      ...
      Hashtable localHashtable = (Hashtable)fGlobalMapStack.pop();
