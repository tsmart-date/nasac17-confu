    ...
    throws SAXException
  {
    ...
    if (grammar != null)
    {
      ...
      if ((grammar instanceof XSGrammarPoolContainer))
      {
        ...
        UnparsedEntityHandler localUnparsedEntityHandler = new UnparsedEntityHandler(fSchemaValidationManager);
        localXMLParserConfiguration.setDTDHandler(localUnparsedEntityHandler);
        localUnparsedEntityHandler.setDTDHandler(xmlReader);
        xmlReader.setDTDSource(localUnparsedEntityHandler);
