  ...
  implements XMLComponent, XMLDocumentFilter, XMLDTDFilter
{
    ...
    throws XNIException
  {
    ...
    if (!isRootDocument())
    {
      ...
      if (fParentXIncludeHandler.searchForRecursiveIncludes(paramXMLLocator)) {
    ...
    if (str1.equals(XINCLUDE_PARSE_XML))
    {
      ...
      if (((str2 != null) && (fXPointerChildConfig == null)) || ((str2 == null) && (fXIncludeChildConfig == null)))
      {
        ...
        if (str2 != null)
        {
          ...
          ((XPointerHandler)fXPtrProcessor).setProperty("http://apache.org/xml/features/xinclude/fixup-base-uris", new Boolean(fFixupBaseURIs));
          ((XPointerHandler)fXPtrProcessor).setProperty("http://apache.org/xml/features/xinclude/fixup-language", new Boolean(fFixupLanguage));
          if (fErrorReporter != null) {
