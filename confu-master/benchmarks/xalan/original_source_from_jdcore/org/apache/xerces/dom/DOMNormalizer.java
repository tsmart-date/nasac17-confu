  ...
  implements XMLDocumentHandler
{
    ...
    if ((fConfiguration.features & 0x40) != 0)
    {
      ...
      else
      {
        ...
        if (localObject1 != null) {
          str3 = (String)fConfiguration.getProperty("http://java.sun.com/xml/jaxp/properties/schemaSource");
        }
  ...
  protected final void namespaceFixUp(ElementImpl paramElementImpl, AttributeMap paramAttributeMap)
  {
    ...
    if (paramAttributeMap != null)
    {
      ...
      {
        localAttr = (Attr)fAttributeList.elementAt(j);
        fLocator.fRelatedNode = localAttr;
        localAttr.normalize();
        ...
        if (str2 != null)
        {
          ...
          if ((str2 == null) || (!str2.equals(NamespaceContext.XMLNS_URI)))
          {
            ...
            if ((fDocument.errorChecking) && ((fConfiguration.features & 0x100) != 0))
            {
              isAttrValueWF(fErrorHandler, fError, fLocator, paramAttributeMap, localAttr, localAttr.getValue(), fDocument.isXML11Version());
              if (fDocument.isXMLVersionChanged())
              {
                boolean bool = CoreDocumentImpl.isXMLName(localAttr.getNodeName(), fDocument.isXML11Version());
                if (!bool)
                {
                  str6 = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "wf-invalid-character-in-node-name", new Object[] { "Attribute", localAttr.getNodeName() });
