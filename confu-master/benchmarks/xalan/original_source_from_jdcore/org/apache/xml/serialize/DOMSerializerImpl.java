  ...
  implements LSSerializer, DOMConfiguration
{
    ...
    throws DOMException, LSException
  {
    ...
    if ((str1 != null) && (str1.equals("1.1")))
    {
      ...
      localObject = xml11Serializer;
    }
    else
    {
      localObject = serializer;
    }
    StringWriter localStringWriter = new StringWriter();
    try
    {
      prepareForSerialization((XMLSerializer)localObject, paramNode);
      _format.setEncoding("UTF-16");
      ((BaseMarkupSerializer)localObject).setOutputCharStream(localStringWriter);
      if (paramNode.getNodeType() == 9)
      {
        ((BaseMarkupSerializer)localObject).serialize((Document)paramNode);
      }
      else if (paramNode.getNodeType() == 11)
      {
        ((BaseMarkupSerializer)localObject).serialize((DocumentFragment)paramNode);
      }
      else if (paramNode.getNodeType() == 1)
      {
        ((BaseMarkupSerializer)localObject).serialize((Element)paramNode);
      }
      else
      {
    ...
    catch (IOException localIOException)
    {
      ...
      throw new DOMException((short)2, str3);
    }
    ...
    try
    {
      ...
      if (localObject2 == null)
      {
        if (localOutputStream == null)
        {
          ...
          localObject3 = new URL(str4 != null ? str4 : str3);
          ...
          ((BaseMarkupSerializer)localObject1).setOutputByteStream((OutputStream)localObject4);
        }
        else
        {
    ...
    throws LSException
  {
    ...
    try
    {
      ...
      URL localURL = new URL(str3 != null ? str3 : paramString);
      Object localObject2 = null;
      localObject3 = localURL.getProtocol();
      String str4 = localURL.getHost();
      if ((((String)localObject3).equals("file")) && ((str4 == null) || (str4.length() == 0) || (str4.equals("localhost"))))
      {
        localObject2 = new FileOutputStream(getPathWithoutEscapes(localURL.getFile()));
      }
      else
      {
      ...
      ((BaseMarkupSerializer)localObject1).setOutputByteStream((OutputStream)localObject2);
      if (paramNode.getNodeType() == 9) {
        ((BaseMarkupSerializer)localObject1).serialize((Document)paramNode);
      } else if (paramNode.getNodeType() == 11) {
        ((BaseMarkupSerializer)localObject1).serialize((DocumentFragment)paramNode);
